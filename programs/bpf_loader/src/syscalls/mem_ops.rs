...
impl<'a> Iterator for MemoryChunkIterator<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        match self.is_account {
            None => self.is_account = Some(region.is_account),
            Some(is_account) => {
                if is_account != region.is_account {
...
mod tests {
    ...
    fn test_memory_chunk_iterator_out_of_bounds() {
        ...
        let memory_mapping = MemoryMapping::new(
            vec![MemoryRegion::new_readonly(&mem1, MM_PROGRAM_START, false)],
            &config,
            &SBPFVersion::V2,
        )
        .unwrap();
    ...
    fn test_memory_chunk_iterator_two() {
        ...
        let memory_mapping = MemoryMapping::new(
            vec![
                MemoryRegion::new_readonly(&mem1, MM_PROGRAM_START, false),
                MemoryRegion::new_readonly(&mem2, MM_PROGRAM_START + 8, false),
            ],
            &config,
            &SBPFVersion::V2,
        )
    ...
    fn test_memset_non_contiguous_readonly() {
        ...
        let memory_mapping = MemoryMapping::new(
            vec![
                MemoryRegion::new_writable(&mut mem1, MM_PROGRAM_START, false),
                MemoryRegion::new_readonly(&mem2, MM_PROGRAM_START + 8, false),
            ],
            &config,
            &SBPFVersion::V2,
    ...
    fn test_memset_non_contiguous() {
        ...
        let memory_mapping = MemoryMapping::new(
            vec![
                MemoryRegion::new_readonly(&mem1, MM_PROGRAM_START, false),
                MemoryRegion::new_writable(&mut mem2, MM_PROGRAM_START + 1, false),
                MemoryRegion::new_writable(&mut mem3, MM_PROGRAM_START + 3, false),
                MemoryRegion::new_writable(&mut mem4, MM_PROGRAM_START + 6, false),
            ],
            &config,
            &SBPFVersion::V2,
        )
    ...
    fn test_memcmp_non_contiguous() {
        ...
        let memory_mapping = MemoryMapping::new(
            vec![
                MemoryRegion::new_readonly(&mem1, MM_PROGRAM_START, false),
                MemoryRegion::new_readonly(&mem2, MM_PROGRAM_START + 3, false),
                MemoryRegion::new_readonly(&mem3, MM_PROGRAM_START + 9, false),
            ],
            &config,
            &SBPFVersion::V2,
        )
